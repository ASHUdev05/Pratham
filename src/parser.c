...
AST_T* parser_parse_statements(parser_T* parser){
    ...
    while(parser->current_token->type == TOKEN_SEMICOLON){
        ...
        compound->compound_value = realloc(compound->compound_value, sizeof(struct AST_STRUCT*) * compound->compound_size);
...
AST_T* parser_parse_function_call(parser_T* parser){
    ...
    while(parser->current_token->type == TOKEN_COMMA){
        ...
        function_call->function_call_arguments = realloc(function_call->function_call_arguments, sizeof(struct AST_STRUCT*) * function_call->function_call_arguments_size);
